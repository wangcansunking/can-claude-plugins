...
| [claude-config-manager](https://github.com/wangcansunking/claude-config-manager) | 管理 Claude Code 配置的 Dashboard + CLI — 配置档案、导出/导入、MCP 市场、插件市场、会话、指标。CLI 优先（`claude-config`）+ 5 个 slash command + 2 个 MCP 工具的极简面。 | 1.2.1 |
